...
export default function Navbar() {
  ...
  const isRangeActive = ['/granny-flats-cabins', '/foundryhomes', '/custom-builds'].includes(pathname)
          ...
          <ul className="nav__links">
            <li className="nav__item nav__item--has-drop">
              ...
              <ul className="nav__drop">
                <li><Link href="/granny-flats-cabins" className={isActive('/granny-flats-cabins') ? 'is-active' : undefined} aria-current={isActive('/granny-flats-cabins') ? 'page' : undefined}>Granny Flats &amp; Cabins</Link></li>
            ...
            <li><Link href="/blog" className={isActive('/blog') ? 'is-active' : undefined} data-magnet="" aria-current={isActive('/blog') ? 'page' : undefined}>Blog</Link></li>
          </ul>
        </nav>
      </div>
